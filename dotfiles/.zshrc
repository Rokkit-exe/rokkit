...
# Example format: plugins=(git zsh-syntax-highlighting zsh-autosuggestions zsh-completions z)
# Add wisely, as too many plugins slow down shell startup.
plugins=(git zsh-syntax-highlighting zsh-autosuggestions zsh-completions z)
...
# >>> ANDROID_SDK (managed by setup-android-sdk) >>>
